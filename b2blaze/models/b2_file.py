...
class B2File(object):
    ...
    def delete_all_versions(self, confirm=False):
        ...
        """
        print(
            self.delete_all_versions.__name__, self.delete_all_versions.__doc__
        )  # Print warnings at call time.
    ...
    def delete(self):
        ...
        params = {"fileId": self.file_id, "fileName": b2_url_encode(self.file_name)}
        response = self.connector.make_request(path=path, method="post", params=params)
